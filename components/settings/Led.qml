...
Item {
	...
	Rectangle {
		...
		Rectangle {
			...
			width: Theme.geometry.radioButton.indicator.dot.width
			height: Theme.geometry.radioButton.indicator.dot.width
			radius: Theme.geometry.radioButton.indicator.dot.width / 2
