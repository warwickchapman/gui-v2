		...
		model: ObjectModel {
			ListRadioButtonGroup {
				...
				optionModel: [
					...
					//% "Standby"
					{ display: qsTrId("devicelist_battery_standby"), value: 0xfc },
			...
			ListTextItem {
				...
				secondaryText: {
					...
					switch (dataValue) {
					case 9:
						return CommonWords.status_running
					case 10:
					...
					case 14:
						//: Status is 'Standby'
						//% "Standby"
						return qsTrId("devicelist_battery_standby")
					case 15:
			...
			ListTextGroup {
				...
				textModel: [ root.battery.voltage, root.battery.current, root.battery.power ]
			}

			ListQuantityItem {
				//% "State of charge"
				text: qsTrId("battery_state_of_charge")
			...
			ListNavigationItem {
				...
				DataPoint {
					id: lastError
					source: root.serviceUid + "/Diagnostics/LastErrors/1/Error"
				}
			}
			...
			ListNavigationItem {
				...
				DataPoint {
					id: nrOfDistributors
					source: root.serviceUid + "/NrOfDistributors"
				}
			}
			...
			ListNavigationItem {
				...
				DataPoint {
					id: allowToCharge
					source: root.serviceUid + "/Io/AllowToCharge"
				}
			}
			...
			ListNavigationItem {
				...
				DataPoint {
					id: nrOfBatteries
					source: root.serviceUid +"/System/NrOfBatteries"
				}
			}
