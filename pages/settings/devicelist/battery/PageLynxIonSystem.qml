	...
	GradientListView {
		model: ObjectModel {
			...
			ListQuantityGroup {
				...
				DataPoint {
					id: minCellVoltage
					dataSource: root.bindPrefix + "/System/MinCellVoltage"
				}

				DataPoint {
					id: maxCellVoltage
					dataSource: root.bindPrefix + "/System/MaxCellVoltage"
				}
			}
			...
			ListQuantityGroup {
				...
				DataPoint {
					...
					dataSource: root.bindPrefix + "/System/MinCellTemperature"
				}

				DataPoint {
					id: maxCellTemperature
					dataSource: root.bindPrefix + "/System/MaxCellTemperature"
				}
			}
